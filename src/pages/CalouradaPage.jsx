                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-white p-8 border-2 border-gray-200">
                            ...
                            <p className="text-gray-700 leading-relaxed text-justify">
                                A Festa de Recepção é o evento de integração entre calouros e veteranos, realizado em formato open bar para celebrar o início do período letivo. A celebração foca na convivência e no acolhimento dos novos estudantes.
                            </p>
                        </div>
                    </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-display font-bold text-xl">26 de Março</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-display font-bold text-xl">21:00</p>
                                    </div>
                                </div>
